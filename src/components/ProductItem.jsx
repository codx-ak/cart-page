    ...
    <Card variant='outlined' sx={{width:280,height:300}}>
        ...
        <CardContent>
          <Typography variant='subtitle2' color={'gray'} fontSize={{sm:12,md:14}}>{product.category}</Typography>
            <Typography variant='h6' textOverflow={'ellipsis'} fontSize={{sm:14,md:16}} overflow={'hidden'} whiteSpace={'nowrap'}>{product.title}</Typography>
            ...
            <Button type='button' variant='outlined' onClick={()=>dispatch(AddCart(product))} fullWidth startIcon={<BiSolidCart/>}>Add to Cart</Button>
        </CardContent>
    </Card>
  )
}
